...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen bg-white text-gray-900 relative overflow-x-hidden font-sans">

      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center min-h-screen px-6 text-center">
        {/* Animated Background Circles */}
        <div className="absolute top-[-150px] left-[-150px] w-96 h-96 rounded-full bg-gradient-to-tr from-[#00c6ff] to-[#0072ff] opacity-20 animate-pulse-slow -z-10"></div>
        <div className="absolute bottom-[-150px] right-[-150px] w-96 h-96 rounded-full bg-gradient-to-tr from-[#ff6a00] to-[#ffcc00] opacity-20 animate-pulse-slow -z-10"></div>

        {/* Logo */}
        <motion.img
          src="https://www.zeniusit.com/assets/images/asset-32x-450x233.png"
          alt="Zenius Logo"
        ...
        <motion.h1
    className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-snug max-w-4xl mb-4"
    initial={{ opacity: 0, y: -40 }}
    animate={{ opacity: 1, y: 0, transition: { duration: 1 } }}
  >
    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] to-[#0072ff]">AI-Powered</span>{" "}
    Solutions for <span className="text-[#ff8a3c]">Innovators</span>
  </motion.h1>
  ...
  >
    <button className="bg-gradient-to-r from-[#00d4ff] to-[#0072ff] text-white font-semibold px-10 py-3 rounded-full shadow-lg hover:scale-105 hover:from-[#33e0ff] hover:to-[#3399ff] transition-transform transition-colors">
      Get Started
    </button>
    <button className="bg-white text-gray-900 font-semibold px-10 py-3 rounded-full shadow hover:scale-105 transition-transform border border-gray-300">
      Learn More
    </button>
  </motion.div> 
      ...
      <section className="w-full py-32 px-6 flex flex-col items-center bg-gradient-to-r from-[#f5f7fa] to-[#c3cfe2]">
        <motion.h2
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 text-center mb-6"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0, transition: { duration: 1 } }}
        >
        ...
        <motion.p
          className="text-gray-700 text-center max-w-2xl mb-8 text-lg sm:text-xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0, transition: { duration: 1, delay: 0.2 } }}
        >
          Partner with Zenius IT Services to unlock AI-driven innovation, scalable solutions, and digital transformation for your enterprise.
        </motion.p>
        <motion.button
          className="mt-6 bg-gradient-to-r from-[#00c6ff] to-[#0072ff] text-white font-semibold px-10 py-3 rounded-full shadow-2xl hover:scale-105 hover:from-[#33d1ff] hover:to-[#3399ff] transition-transform transition-colors"
          initial={{ opacity: 0, y: 20 }}
